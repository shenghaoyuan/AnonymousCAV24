...
Instance CINT64 : CType int64 := mkCType _ (cType int64CompilableType).
...
Definition opcode_alu32_eqbSymbolType :=
  MkCompilableSymbolType [opcode_alu32CompilableType; opcode_alu32CompilableType] (Some boolCompilableType).

Definition Const_opcode_alu32_eqb :=
  MkPrimitive opcode_alu32_eqbSymbolType
                opcode_alu32_eqb
                (fun es => match es with
                           | [e1; e2] => Ok (Csyntax.Ebinop Cop.Oeq e1 e2 C_U8)
                           | _       => Err PrimitiveEncodingFailed
                           end).
...
Definition Const_R0 := constant opcode_alu32SymbolType R0 C_U32_zero.
opcode_alu32_eqb *)
...
Module Exports.
  ...
  Definition Const_opcode_alu32_eqb                       := Const_opcode_alu32_eqb.
End Exports.