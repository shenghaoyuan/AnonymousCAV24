...
Definition regToregToboolSymbolType :=
  MkCompilableSymbolType [regCompilableType; regCompilableType] (Some boolCompilableType).

Definition Const_reg_eqb :=
  MkPrimitive regToregToboolSymbolType
                reg_eqb
                (fun es => match es with
                           | [e1; e2] => Ok (Csyntax.Ebinop Cop.Oeq e1 e2 C_U32)
...
Definition regTonatSymbolType :=
  MkCompilableSymbolType [regCompilableType] (Some natCompilableType).

Definition Const_reg2nat :=
  MkPrimitive regTonatSymbolType
                reg2nat
                (fun es => match es with
                           | [r] => Ok r
                           | _       => Err PrimitiveEncodingFailed
...
Definition regTointSymbolType :=
  MkCompilableSymbolType [regCompilableType] (Some uint32CompilableType).

Definition Const_int_of_reg :=
  MkPrimitive regTointSymbolType
                int_of_reg
                (fun es => match es with
                           | [r] => Ok r
                           | _       => Err PrimitiveEncodingFailed
...
Definition regToint16SymbolType :=
  MkCompilableSymbolType [regCompilableType] (Some uint16CompilableType).

Definition Const_int16_of_reg :=
  MkPrimitive regToint16SymbolType
                int16_of_reg
                (fun es => match es with
                           | [r] => Ok r
                           | _       => Err PrimitiveEncodingFailed
...
Module Exports.
  ...
  Definition Const_reg_eqb          := Const_reg_eqb.
  Definition Const_eval_regmap      := Const_eval_regmap.
  Definition Const_upd_regmap       := Const_upd_regmap.
  Definition Const_reg2nat          := Const_reg2nat.
  Definition Const_int_of_reg       := Const_int_of_reg.
  Definition Const_int16_of_reg     := Const_int16_of_reg.
End Exports.