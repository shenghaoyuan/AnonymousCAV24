...
From bpf.jit Require Import ThumbInsOp.
...
Definition C_NOP_OP: Csyntax.expr :=
  Csyntax.Eval (Vint NOP_OP) C_U16.
...
Definition C_UDIV_LO_OP: Csyntax.expr :=
  Csyntax.Eval (Vint UDIV_LO_OP) C_U16.

Definition C_UDIV_HI_OP: Csyntax.expr :=
  Csyntax.Eval (Vint UDIV_HI_OP) C_U16.

Definition C_BX_OP: Csyntax.expr :=
  Csyntax.Eval (Vint BX_OP) C_U16.

Definition C_B_OP_LOW: Csyntax.expr :=
  Csyntax.Eval (Vint B_OP_LOW) C_U16.

Definition C_B_OP_HI: Csyntax.expr :=
  Csyntax.Eval (Vint B_OP_HI) C_U16.
...
Definition Const_NOP_OP     := constant uint16SymbolType NOP_OP C_NOP_OP.
...
Definition Const_UDIV_LO_OP := constant uint16SymbolType UDIV_LO_OP C_UDIV_LO_OP.

Definition Const_UDIV_HI_OP := constant uint16SymbolType UDIV_HI_OP C_UDIV_HI_OP.

Definition Const_BX_OP      := constant uint16SymbolType BX_OP C_BX_OP.

Definition Const_B_OP_LOW   := constant uint16SymbolType B_OP_LOW C_B_OP_LOW.
Definition Const_B_OP_HI    := constant uint16SymbolType B_OP_HI C_B_OP_HI.
...
Module Exports.
  ...
  Definition Const_NOP_OP     := Const_NOP_OP.
  ...
  Definition Const_UDIV_LO_OP := Const_UDIV_LO_OP.
  Definition Const_UDIV_HI_OP := Const_UDIV_HI_OP.
  Definition Const_BX_OP      := Const_BX_OP.
  Definition Const_B_OP_LOW   := Const_B_OP_LOW.
  Definition Const_B_OP_HI    := Const_B_OP_HI.
