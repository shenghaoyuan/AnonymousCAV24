...
Section Get_opcode_mem_st_imm.
  ...
  Definition f : arrow_type args (M State.state res) := get_opcode_mem_st_imm.
  ...
  Definition match_res : res -> Inv State.state := fun x  => StateLess _ (opcode_mem_st_imm_correct x).

  Instance correct_function_get_opcode_mem_st_imm : forall a, correct_function _ p args res f fn ModNothing true match_state match_arg_list match_res a.
  Proof.
