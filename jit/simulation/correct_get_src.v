...
Section Get_src.
  ...
  Definition match_res : res -> Inv hybrid_state := fun x  => StateLess _ (reg_correct x).

  Instance correct_function_get_src : forall a, correct_function _ p args res f fn ModNothing true match_state match_arg_list match_res a.
  Proof.
    ...
    subst.
    unfold z_to_reg, BinrBPF.get_src in Hsrc.
    simpl in c.
