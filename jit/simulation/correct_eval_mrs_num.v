...
Section Eval_mrs_num.
  ...
  Definition match_res : res -> Inv hybrid_state := fun re => StateFull _ (fun v st m => nat_correct re v /\ re = (mrs_num st)).
  ...
  Proof.
    ...
    split_and.
    {
      ...
      + rewrite Ptrofs.add_zero_l.
        unfold Coqlib.align; simpl. change (416 / 8)%Z with 52%Z.
