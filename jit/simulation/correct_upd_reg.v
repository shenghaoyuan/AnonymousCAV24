...
Section Upd_reg.
  ...
  Definition f : arrow_type args (M res) := upd_reg.
...
Definition match_arg_list : DList.t (fun x => x -> Inv _) ((unit:Type) ::args) :=
  ...
  Proof.
    ...
    unfold eval_inv, val32_correct in c3.
    ...
    - (* goal: Smallstep.star  _ _ (State _ (Ssequence ... *)
      ...
      assert (Heq: (4 * id_of_reg c)%Z = (Ptrofs.unsigned (Ptrofs.mul (Ptrofs.repr 4) (Ptrofs.of_intu (Int.repr (id_of_reg c)))))). {
