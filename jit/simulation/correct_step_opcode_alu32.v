...
From bpf.simulation Require Import correct_get_opcode_alu32 correct_upd_reg correct_upd_flag.
  ...
  Proof.
    ...
    - (**r op_BPF_ADD32 *)
      ...
      + simpl.
        ...
        exists (v ::v0 :: Vint (Int.add vl1 vl2) :: nil). (**r star here *)
    ...
    - (**r op_BPF_SUB32 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::v0 :: Vint (Int.sub vl1 vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
    ...
    - (**r op_BPF_MUL32 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::v0 :: Vint (Int.mul vl1 vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
    ...
    - (**r op_BPF_DIV32 *)
      ...
      + simpl.
        ...
        exists (v ::v0 :: Vint (Int.divu vl1 vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::Vint (Int.repr 10) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0.
        split.
        simpl.
        ...
        get_invariant _src32.
        unfold exec_expr.
        rewrite p0. unfold Vzero, rBPFValues.comp_ne, Int.zero.
    ...
    - (**r op_BPF_OR32 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::v0 :: Vint (Int.or vl1 vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
    ...
    - (**r op_BPF_AND64 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::v0 :: Vint (Int.and vl1 vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
    ...
    - (**r op_BPF_LSH32 *)
      ...
      + simpl.
        ...
        exists (v :: v0 :: (Val.shl (Vint vl) (Vint vi)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
        ...
        unfold eval_inv,is_state_handle in c3.
        subst.
        exists ((Vptr st_blk Ptrofs.zero) :: Vint (Int.repr 11) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0.
    ...
    - (**r op_BPF_RSH32 *)
      ...
      + simpl.
        ...
        unfold stateless, val32_correct in c6.
        destruct c6 as (Hv2_eq & (vi & Hvi_eq)); subst.
        exists (v :: v0 :: (Val.shru (Vint vl) (Vint vi)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
    ...
    - (**r op_BPF_NEG64 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v :: v0 :: (Val.neg (Vint vl1)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::Vint (Int.repr 2) :: nil). (**r star here: it should be -1 *)
        unfold map_opt, exec_expr.
        rewrite p0.
        split.
        simpl.
    ...
    - (**r op_BPF_MOD32 *)
      ...
      + simpl.
        ...
        unfold rBPFValues.comp_ne in Hcnd.
        rewrite Bool.negb_true_iff in Hcnd.
        rewrite Hcnd.
        exists (v ::v0 :: (Vint (Int.modu vl1 vl2)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
        ...
        get_invariant _src32.
        unfold exec_expr.
        rewrite p0. unfold rBPFValues.comp_ne, Int.zero.
        unfold Cop.sem_binary_operation, Cop.sem_cmp, Cop.sem_binarith, Cop.sem_cast; simpl.
        unfold stateless, val32_correct in c3.
        destruct c3 as (c3_0 & c3_vl & c3_1).
        subst.
    ...
    - (**r op_BPF_XOR32 *)
      ...
      + simpl.
        ...
        exists (v ::v0 :: (Vint (Int.xor vl1 vl2)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        unfold Cop.sem_binary_operation, typeof.
    ...
    - (**r op_BPF_MOV32 *)
      ...
      + simpl.
        ...
        destruct c5 as (Hv1_eq & (vl1 & Hvl1_eq)); subst.
        destruct c6 as (Hv2_eq & (vl2 & Hvl2_eq)); subst.
        exists (v ::v0 :: (Vint vl2) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p3.
    ...
    - (**r op_BPF_ARSH32 *)
      ...
      + simpl.
        ...
        unfold val32_correct in c6.
        destruct c6 as (Hv2_eq & (vi & Hvi_eq)); subst.
        exists (v ::v0 :: (Val.shr (Vint vl) (Vint vi)) :: nil). (**r star here *)
        unfold map_opt, exec_expr.
        rewrite p0, p1, p2, p3.
        simpl.
        unfold Cop.sem_shr, Cop.sem_shift; simpl.
