...
Lemma exec_alu32_lsl_r1_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    ...
    (Hlt_32 : Int.ltu si Int.iwordsize = true)
...
Lemma exec_alu32_lsl_r1_neq_dst_not_in_ld_set:
  forall (dst: breg) si l1 l2 ld_set st_set ld_set2 st_set2
    ...
    (Hl1 : l2 ++
      ...
      encode_arm32 (encode_arm32 (Int.repr 15) (encode_arm32 (int_of_breg dst) (int_of_ireg IR11) 8 4) 12 4)
        (encode_arm32 (int_of_breg dst) LSL_R_OP 0 4) 16 16] =
      l1)
    (HST : match_states jit_blk st_blk ld_set st_set (State rs0 m1) (AState ars0 astk0 astkb am))
    (Hrs1 : rs1 =
       BPregmap.set BPC (Val.add (BPregmap.set dst (Vint i) rs0 BPC) Vone)
...
Proof.
  ...
  assert (Hhi_0 : decode_arm32 si 0 16 = si). {
    clear - Hlt_32.
    apply int_le_0_32_size_5; auto.
  }

  simpl in Hlt_32.
  rewrite andb_true_iff in Hlt_32.
  destruct Hlt_32 as (_ & Hlt_32).
  replace (Int.repr 32%Z) with Int.iwordsize in Hlt_32 by reflexivity.
  destruct set_mem eqn: Hdst_in in Hl2.
  - (**r dst in ld /\ st *)
    subst l2.
    rewrite app_nil_l in Hl1.
    eapply exec_alu32_lsl_r1_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_lsl_r1_neq_dst_not_in_ld_set; eauto.
Qed.


Lemma exec_alu32_lsr_r1_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
...
Lemma exec_alu32_lsr_r1_neq_dst_not_in_ld_set:
  forall (dst: breg) si l1 l2 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.shru (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = false)
    ...
    (Hl1 : l2 ++
      [mov_int_to_movwt si IR11 MOVW_OP;
      encode_arm32 (encode_arm32 (Int.repr 15) (encode_arm32 (int_of_breg dst) (int_of_ireg IR11) 8 4) 12 4)
        (encode_arm32 (int_of_breg dst) LSR_R_OP 0 4) 16 16] =
      l1)
    (HST : match_states jit_blk st_blk ld_set st_set (State rs0 m1) (AState ars0 astk0 astkb am))
    (Hrs1 : rs1 =
       BPregmap.set BPC (Val.add (BPregmap.set dst (Vint i) rs0 BPC) Vone)
...
Proof.
  ...
  - (**r dst in ld /\ st *)
    subst l2.
    rewrite app_nil_l in Hl1.
    eapply exec_alu32_lsr_r1_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_lsr_r1_neq_dst_not_in_ld_set; eauto.
Qed.


Lemma exec_alu32_asr_r1_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
...
Lemma exec_alu32_asr_r1_neq_dst_not_in_ld_set:
  forall (dst: breg) si l1 l2 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.shr (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = false)
    ...
    (Hl1 : l2 ++
      [mov_int_to_movwt si IR11 MOVW_OP;
      encode_arm32 (encode_arm32 (Int.repr 15) (encode_arm32 (int_of_breg dst) (int_of_ireg IR11) 8 4) 12 4)
        (encode_arm32 (int_of_breg dst) ASR_R_OP 0 4) 16 16] =
      l1)
    (HST : match_states jit_blk st_blk ld_set st_set (State rs0 m1) (AState ars0 astk0 astkb am))
    (Hrs1 : rs1 =
       BPregmap.set BPC (Val.add (BPregmap.set dst (Vint i) rs0 BPC) Vone)
...
Proof.
  ...
  - (**r dst in ld /\ st *)
    subst l2.
    rewrite app_nil_l in Hl1.
    eapply exec_alu32_asr_r1_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_asr_r1_neq_dst_not_in_ld_set; eauto.
Qed.