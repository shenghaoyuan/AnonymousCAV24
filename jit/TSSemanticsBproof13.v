...
Lemma exec_alu32_and_i_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    ...
    (Hl1 : [encode_arm32 (encode_arm32 (int_of_breg dst) si 8 4) (encode_arm32 (int_of_breg dst) AND_I_OP 0 4) 16 16] = l1)
...
Lemma exec_alu32_and_i_neq_dst_not_in_ld_set:
...
Proof.
  ...
  - (**r dst in ld /\ st *)
    ...
    eapply exec_alu32_and_i_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_and_i_neq_dst_not_in_ld_set; eauto.
Qed.


Lemma exec_alu32_and_r1_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.and (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = true)
...
Lemma exec_alu32_and_r1_neq_dst_not_in_ld_set:
  forall (dst: breg) si l1 l2 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.and (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = false)
...
Proof.
  ...
  - (**r dst in ld /\ st *)
    subst l2.
    rewrite app_nil_l in Hl1.
    eapply exec_alu32_and_r1_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_and_r1_neq_dst_not_in_ld_set; eauto.
Qed.

Lemma exec_alu32_and_r2_neq_dst_in_ld_set:
  forall (dst: breg) si l1 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.and (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = true)
...
Lemma exec_alu32_and_r2_neq_dst_not_in_ld_set:
  forall (dst: breg) si l1 l2 ld_set st_set ld_set2 st_set2
    (rs0 rs1: regset) i jit_blk st_blk m1 ars0 astk0 astkb am
    (HALU : Val.and (rs0 dst) (Vint si) = Vint i)
    (Hdst_in : set_mem breg_eq dst (set_union breg_eq ld_set st_set) = false)
...
Proof.
  ...
  - (**r dst in ld /\ st *)
    subst l2.
    rewrite app_nil_l in Hl1.
    eapply exec_alu32_and_r2_neq_dst_in_ld_set; eauto.
  - (**r dst not in ld /\ st *)
    eapply exec_alu32_and_r2_neq_dst_not_in_ld_set; eauto.
Qed.